...
def prepare_output_directory(requested: str | Path | None, root: str | Path = "output") -> Path:
    ...
    for child in (candidate / "cleaned", candidate / "tables", candidate / "graphs" / "stage3_diagnostics", candidate / "graphs" / "stage4_diagnostics", candidate / "graphs" / "stage5_diagnostics"):
